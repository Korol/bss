...
/* @var $searchModel app\modules\admin\models\AboutImageSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('admin', 'About Images');
...
//            ['class' => 'yii\grid\SerialColumn'],
            ...
            [
                'attribute' => 'img',
                'value' => function($data){
                    return (!empty($data->img)) ? Html::img(\yii\helpers\Url::to(['@web/uploads/about/' . $data->img]), ['width' => '250']) : '';
                },
                'format' => 'html',
            ],
            [
