...
/**
 * StaticPagesSearch represents the model behind the search form about `app\modules\admin\models\StaticPages`.
 */
class StaticPagesSearch extends StaticPages
{
    ...
    public function rules()
    {
        return [
            ...
            [['type', 'title', 'content', 'meta_keywords', 'meta_description'], 'safe'],
        ];
    }
