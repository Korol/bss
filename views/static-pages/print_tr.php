...
<div class="container ptext">
    <p class="h3" style="text-align: center;"><b>Bilgisayarınızı Boss'dan yazdırmak üzere ayarla</b></p>
    <br>
    ...
    <div class="row" style="margin: 10px">
        <div class="col-md-8 col-xs-8">
            ...
            <br>
            <br>
            <p><b>2) Yazdırma işlemi için kullanmak istediğiniz yazıcıyı belirleyin.</b></p>
            <p><a target="_blank" href="chrome://devices/">chrome://devices</a> linkini Google Chrome adres çubuğuna kopyalayın – çalışmaya hazır olan tüm yazıcılar görüntülenecektir.</p>
    ...
    <p style="margin-bottom: 40px;"><b>Şimdi her şeyin doğru yaptığınızdan emin olmak için sadece telefonuzuza/tabletinize PrintHand uygulamasını kurun ve Boss'tan test sayfası çıktısını yapın. Yazıcınızın ve bilgisayarınızın açık ve telefonunuzun/ tabletinizin İnternet'e bağlı olması gerektiğini unutmayın.</b></p>
</div>