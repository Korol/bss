...
<div class="container ptext">
    <p class="h3" style="text-align: center;"><b>Настройка компьютера для печати из Boss</b></p>
    <br>
    ...
    <div class="row" style="margin: 10px">
        <div class="col-md-8 col-xs-8">
            ...
            <br>
            <br>
            <p><b>2) Настройте принтер, на котором хотите печатать</b></p>
            <p>Скопируйте ссылку <a target="_blank" href="chrome://devices/">chrome://devices</a> в адресную строку Google Chrome – и вы увидите все принтеры, которые уже готовы к работе.</p>
    ...
    <p style="margin-bottom: 40px;"><b>Теперь вам осталось только установить приложение PrintHand на телефон/планшет и выполнить тестовую печать из Boss, чтобы проверить, что вы все сделали правильно.
            Напоминаем, что для работы ваш принтер и компьютер должны быть включены, а телефон/планшет подключен к Интернету.</b></p>
</div>